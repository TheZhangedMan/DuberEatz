 ...
 * Ethan Zhang
 * November 6, 2019
 * This code solve mazes with one or more destinations, finding the least amount of steps required and creating a PPM file for the solved maze.
 * This code is incompatible with destinations that are not the number one.
 */

public class DuberEatzLevelFour {
      ...
      for (int j = 0; j < 10; j++) { //The length of each PPM map tile is ten pixels.
        for (int k = 0; k < width; k++) {
          for (int l = 0; l < 10; l++) { //The width of each PPM map tile is ten pixels.
            if (trail[i][k] == true) { //If j tile has been visited, mark it as part of the trail to compensate for erased trails.
              optimal[i][k] = "x";
            }
